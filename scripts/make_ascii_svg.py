...
GH_USERNAME = "tushar-sharma001"
DISPLAY_NAME = "Tushar Sharma"

parts.append(f'<text x="{CANVAS_W/2}" y="{TITLEBAR_H/2 + 4}" fill="{TITLE_TEXT}" font-size="12" '
             f'text-anchor="middle">{GH_USERNAME}@github: ~$ ./portrait.sh</text>')
...
parts.append(f'<text x="{PAD}" y="{status_y:.1f}" fill="{TITLE_TEXT}" font-size="13">'
             f'{GH_USERNAME}@github:~$ whoami <tspan fill="{INK}">{DISPLAY_NAME}</tspan></text>')
_whoami_prefix = f'{GH_USERNAME}@github:~$ whoami {DISPLAY_NAME}'
_cursor_x = PAD + len(_whoami_prefix) * 7.6
