...
# ===========================================================================
HOST = "tushar-sharma001"   # shown as  tushar-sharma001@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Open to Data Science / AI / SWE roles"),
    ("kv", "Prev", "AI Intern @ Infosys ('25)"),
    ("kv", "Also", "AI + Prompt Eng Intern @ Edunet Foundation"),
    ("kv", "Edu", "BCA, GGSIPU '28 -- GPA 9.5/10"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Languages", "Python, SQL, Java, C, JavaScript"),
    ("kv", "ML / DL", "Scikit-learn, TensorFlow, PyTorch"),
    ("kv", "AI / NLP", "Generative AI, Prompt Eng, Vertex AI"),
    ("kv", "Cloud", "GCP, AWS, Docker, GitHub Actions"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Organized CodeSlayer 2K25 hackathon @ NIT Delhi"),
    ("bul", "AWS AI & ML Scholar '26 -- Harvard Aspire alum"),
    ("bul", "Campus Ambassador: Google, GfG, Unstop"),
]
